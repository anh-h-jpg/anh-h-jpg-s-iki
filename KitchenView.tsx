...
export const KitchenView: React.FC<KitchenViewProps> = ({ isEmbedded = false }) => {
  const {
    currentWeeklyMenu,
    menuItems,
    kitchenSummary,
  ...
  return (
    <div className={isEmbedded ? 'space-y-3' : 'max-w-4xl mx-auto pb-24 pt-2 px-3 sm:px-4'}>
                ...
                {rows.length === 0 ? (
                  ...
                  <div className="divide-y divide-stone-100">
                    {rows.map((row) => {
                      ...
                      const isClosed = Boolean(menuItem?.is_closed);
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Actions: Toggle Button & Big Quantity Display */}
                          <div className="flex items-center gap-2 shrink-0">
                            <button
                              type="button"
                              onClick={() => toggleMenuItemClosed(row.menu_item_id, !isClosed)}
